...
#==LISTA-DE-PAQUETES==#
# Desde XBPS :
sudo xbps-install kitty steam telegram-desktop strawberry obs libresprite kdenlive filezilla virt-manager qemu

# Desde Flatpak :
flatpak install discord vscodium obsidian retroarch portproton Sober gearlever
